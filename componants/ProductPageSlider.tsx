    ...
    return(
        <div>
            ...
            <div className="carousel-indicators position-absolute top-100">
                {product.urlByColor.map((url,index)=>(
                    <button key={index} type="button" data-bs-target="#carouselExampleIndicators" data-bs-slide-to={index} style={{backgroundImage:`url(${url})`,height:'20vh',maxHeight:'120px',backgroundSize:'cover'}}
