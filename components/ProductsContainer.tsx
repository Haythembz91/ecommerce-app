...
const ProductsContainer =({products}:{products:Product[]})=>{
  ...
  return(
    <div>
      <div className={'w-100 overflow-x-scroll sportswearList mb-2 bg-body-secondary'}>
          <ul className={'nav nav-underline gap-0 flex-nowrap list-group list-group-horizontal text-nowrap'}>
              <li className={'nav-item p-1 list-group-item d-flex justify-content-between align-items-center bg-body-secondary'}>
              ...
              {categories.map((category,index)=>
                ...
                <li key={index} className={'nav-item p-1 list-group-item d-flex justify-content-between align-items-center bg-body-secondary '} >
